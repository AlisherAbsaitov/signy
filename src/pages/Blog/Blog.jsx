...
export default function Blog() {
  return (
    <section className="flex items-center justify-around p-[20px]">
      <div>
      ...
      <div>
        ...
        <h1 className="text-[30px] font-bold mt-[20px]">Burn Calories Quicker in 30 Min.</h1>
        <div className="flex gap-x-[20px] mt-[20px]">
          <button className="p-[10px] bg-[#E5E5E5] rounded-[20px]">
            про продукт
          </button>
          <button className="p-[10px] bg-[#E5E5E5] rounded-[20px]">теги</button>
          <button className="p-[10px] bg-[#E5E5E5] rounded-[20px]">
            много тегов
          </button>
        </div>
        <p className="text-[17px] mt-[20px]">
          ...
          структуры играет важную роль в формировании существенных финансовых и <br />
          административных условий. Не следует, однако забывать, что дальнейшее <br />
          развитие различных форм деятельности способствует подготовки и <br />
